...
hu553in · senior product engineer, building voomy
...
- **QIC digital hub** - senior backend engineer, since 2025 - [qic.digital](https://qic.digital/)
- **CV** - [en](https://bit.ly/rkhasanshin-cv) · [ru](https://bit.ly/rkhasanshin-cv-ru)

## Stack

- **work**: Go, Postgres, Kafka, Redis
- **side**: TypeScript, Next.js, Vercel, shadcn/ui, Tailwind CSS, Drizzle
- **infra**: Linux, Docker, Ansible, Nginx, Caddy
- **roots**: Java, Kotlin, Spring Boot, React, C/C++
...
- Instagram: [hu553in___](https://www.instagram.com/hu553in___)
- Email: hu553in@poke.com
